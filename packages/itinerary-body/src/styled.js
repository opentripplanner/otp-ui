...
export const LegBody = styled.div`
  color: #676767; /* from #999 to meet WCAG */
  font-size: 13px;
...
export const LegDescriptionForTransit = styled(LegDescription)`
  color: #807373; /* from rgb(153, 153, 153) to meet WCAG */
  margin-top: 5px;
`;
...
export const PlaceSubheader = styled.div`
  color: #807373; /* from "gray" to meet WCAG */
  font-weight: 300;
  padding-left: 4px;
  padding-top: 1px;
`;
...
export const PreviewDiagramElevationGain = styled(
  ...
  color: #e60000; /* from "red" to meet WCAG */
`;
...
export const StepIconContainer = styled.div`
  fill: #676767; /* from #999 to meet WCAG */
  float: left;
  height: 16px;
  width: 16px;
`;
