...
// This file is copied and modified to pass linting from the react-leaflet repo:
// See https://github.com/PaulLeCam/react-leaflet/blob/v2/__mocks__/leaflet.js
...
module.exports = {
  ...LeafletMock,
  canvasLayer: () => new CanvasLayerMock(),
  Control: ControlMock,
  control: controlMock,
  LatLng: L.LatLng,
  latLng: L.latLng,
